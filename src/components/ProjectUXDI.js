...
class ProjectUXDI extends Component {
    render() {
        ...
        <div className="projectuxdi">
            ...
            <p className="description">Check out the site <a href="http://uxdi-sei-fetch.surge.sh" target="_blank">here</a></p>
            </div>
            <div>
                <h2>Fetch</h2>
                <p>A site to display pet information. Made in collaboration with a group of UX designers.</p>
            <h6>
                <a href="https://github.com/rursteve2/fetch" target="_blank">
                    View it on Github
                </a>
            </h6>
            </div>
